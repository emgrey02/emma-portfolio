	...
	return (
		<Layout>
			...
			<p>
				...
				may even think that because they have no "musical talent," they
				shouldn't even try.
			</p>
			<p>
			...
			<p>
				...
				of the site, less words and more icons so users don't get scared
				about not knowing what a word means and are encouraged to poke
				around and press things, and big undo/redo buttons so the user
				never has to fear about making a permanent mistake.
			</p>
			<Image

    ...
    return (
        <Layout>
            ...
            <p>
                ...
                of brutalism in there. I call it &quot;Drawing Board&quot;.
                Starting with an HTML file, I wrote a stylesheet with SCSS to
                create my own styled version of the webpage. Requirements
                included being fully accessible: proper color contrast,
                skip-navigation link, 200% zoom check, image alt text, and more.
                Some CSS techniques I used were clamp(), list counter, nth-child
                selectors, grid, pseudo elements, and clip-paths.
            </p>
            <p>
                You can check out all of the community contributions by clicking
                the link to see mine and following the &quot;All Styles&quot;
                link in the navigation bar. I encourage you to see how others
                have styled the webpage, and maybe take a shot at participating
                yourself!
            </p>
            <Button
